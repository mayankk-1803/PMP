...
export const CORPORATE_GIFTS = [
  ...
  { name: "Diaries / Notebooks", slug: "diaries", href: "/products?category=diaries" },
  ...
  { name: "Coasters", slug: "coasters", href: "/products?category=coasters" },
  { name: "Umbrellas", slug: "umbrellas", href: "/products?category=umbrellas" },
  { name: "Standees", slug: "standees", href: "/products?category=standees" },
  { name: "Raincoats", slug: "raincoats", href: "/products?category=raincoats" },
...
export const BRANDS = [
  ...
  { name: "Blue Pond", logo: "/logos/bluepond.png" }
];
...
export const PRODUCTS: Record<string, ProductItem> = {
  ...
  "anti-slip-leather-mouse-pad": {
    title: "Anti-Slip Leather Mouse Pad",
    category: "mouse-pads",
    budget: "Under ₹250",
    basePrice: 180,
    description: "Premium executive leather mouse pad designed with stitched edges, a splash-resistant polyurethane coat, and anti-slip rubber backing. Ideal for upscale conference tables.",
    images: [
    ...
    specs: [
      { label: "Material", value: "Premium PU Leatherette outer" },
      { label: "Backing", value: "Natural non-slip rubber grip" },
      { label: "Branding Area", value: "Top-center (Embossing / Laser)" },
      { label: "Dimensions", value: "240mm x 200mm x 3mm" },
      { label: "Production SLA", value: "6-8 Working Days" }
    ],
    customizations: ["Blind Debossing", "Metallic Hot Foil Stamping", "Edge Stitch Contrast Color"],
    packagings: ["Eco Kraft Sleeve packaging", "Premium Rigid Case"],
    moq: 100
  },
  ...
  "royal-wooden-coaster-set": {
    title: "Royal Wooden Coaster Set",
    category: "coasters",
    budget: "Under ₹250",
    basePrice: 190,
    description: "Set of four premium coasters carved from durable rosewood and organized inside a dedicated wooden holder. Elegant desktop accessory decorated with laser engraved logos.",
    images: [
      "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=800&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=600&auto=format&fit=crop"
    ],
    specs: [
      { label: "Material", value: "Premium Polished Indian Rosewood" },
      { label: "Base Padding", value: "Scratch-resistant velvet padding" },
      { label: "Quantity", value: "4 Coasters + 1 Wooden holder" },
      { label: "Coaster Size", value: "90mm x 90mm x 8mm" },
      { label: "Production SLA", value: "6-8 Working Days" }
    ],
    customizations: ["Laser Deep Engraving", "Metal logo inlay work", "Silkscreen Print"],
    packagings: ["Paperboard Sleeve box", "Eco Kraft Box with Jute twine"],
    moq: 100
  },
  "windproof-corporate-umbrella": {
    title: "Windproof Corporate Umbrella",
    category: "umbrellas",
    budget: "₹250 - ₹500",
    basePrice: 320,
    description: "Large 27-inch golf umbrella utilizing windproof double-canopy construction and premium fiberglass shafts. Includes custom printed logo on alternating panels.",
    images: [
      "https://images.unsplash.com/photo-1510074377623-8cf13fb86c08?q=80&w=800&auto=format&fit=crop",
      "https://images.unsplash.com/photo-1559827291-72ee739d0d9a?q=80&w=600&auto=format&fit=crop"
    ],
    specs: [
      { label: "Fabric Material", value: "190T Pongee fabric (Waterproof)" },
      { label: "Rib Frame", value: "FRP Fiberglass Windproof frame" },
      { label: "Branding Area", value: "Custom panel printing (Screen/Sublimation)" },
      { label: "Handle", value: "Soft EVA foam grip with push button" },
      { label: "Production SLA", value: "7-8 Working Days" }
    ],
    customizations: ["Multi-panel Screen Print", "Full Sublimation Print", "Engraved Handle Bottom"],
    packagings: ["Self-fabric sleeve", "Clear poly tube packaging"],
    moq: 100
  },
