...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-foreground hover:bg-primary-hover shadow-md",
        outline: "border border-primary text-primary hover:bg-primary/10",
        ghost: "hover:bg-primary/10 text-foreground hover:text-primary",
        gradient: "bg-gradient-to-r from-gradient-start to-gradient-end text-foreground hover:from-primary hover:to-gradient-end shadow-lg shadow-primary/20",
      },
      size: {
