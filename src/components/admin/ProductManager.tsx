  ...
  const load = async () => {
    ...
    try {
      ...
      const runtimeCategories = [
        ...
        { name: "Decoratives", slug: "decoratives" },
        { name: "Household Utilities", slug: "household-utilities" },
      ...
      const runtimeSubcategories = [
        ...
        { name: "Decorative", slug: "decorative", category: "decoratives" },
        { name: "Household Utilities", slug: "household-utilities", category: "household-utilities" },
