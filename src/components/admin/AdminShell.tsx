    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      <div className="grid lg:grid-cols-[280px_1fr]">
        <aside className="border-r border-slate-200 bg-white px-4 py-6 shadow-sm">
          <Link href="/87564/admin/dashboard" className="mb-8 flex items-center gap-3 px-2">
            ...
            <span>
              ...
              <span className="block text-xs text-slate-500">Enterprise Admin</span>
            </span>
          </Link>
        ...
        <section className="min-w-0 px-4 py-6 md:px-8">
          <header className="mb-6 flex flex-col gap-3 border-b border-slate-200 pb-6 md:flex-row md:items-end md:justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.25em] text-red-600">Admin Console</p>
