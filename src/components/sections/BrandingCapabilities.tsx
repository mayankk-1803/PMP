...
const CAPABILITIES: Capability[] = [
  {
    icon: <Cpu className="w-6 h-6 text-[#6E7757]" />,
  ...
  {
    icon: <Layers className="w-6 h-6 text-[#C8A36A]" />,
  ...
  {
    icon: <Sparkles className="w-6 h-6 text-[#C8A36A]" />,
...
export function BrandingCapabilities() {
  return (
    <section className="py-24 bg-[#2B2B2B] border-t border-white/5 relative overflow-hidden text-white">
      ...
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#6E7757]/10 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[#C8A36A]/5 rounded-full blur-[140px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        
        {/* Section Heading */}
        <div className="text-center max-w-3xl mx-auto mb-20">
          <span className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-extrabold tracking-widest uppercase mb-4 inline-block text-[#C8A36A]">
            Craftsmanship & Technology
          </span>
          <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-6">
            Enterprise <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C8A36A] via-[#e8c68a] to-[#C8A36A]">Branding Capabilities</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {CAPABILITIES.map((cap, idx) => (
            <motion.div
              ...
              whileHover={{ y: -6, borderColor: "rgba(200, 163, 106, 0.3)" }}
            ...
            >
              <div>
                ...
                <div className="space-y-2 mb-6">
                  <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#C8A36A]">{cap.subtitle}</span>
                  <h3 className="text-lg font-bold text-white tracking-tight leading-tight group-hover:text-[#C8A36A] transition-colors">
                    {cap.title}
                  </h3>
              ...
              <div className="pt-5 border-t border-white/5 space-y-2 mt-auto">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {cap.materials.map((mat) => (
                    ...
                    >
                      <CheckCircle2 className="w-2.5 h-2.5 text-[#6E7757] flex-shrink-0" />
                      {mat}
                    </span>
                  ))}
                </div>
